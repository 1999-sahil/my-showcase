const blogPostIdeasPrompt = (topic) => `
    ...
    Important: Do NOT add any extra text outside the JSON format. Only returnn valid JSON.
`;

const blogSumaryPrompt = (blogContent) => {
    `
...
module.exports = { blogPostIdeasPrompt, blogSumaryPrompt };