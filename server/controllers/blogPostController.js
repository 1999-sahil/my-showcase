...
const getTopPosts = async (req, res) => {
    try {
        ...
        const posts = await BlogPost.find({ isDraft: false }).sort({ views: -1 }).limit(8);
...
module.exports = { createPost, updatePost, deletePost, getAllPosts, getPostBySlug, getPostsByTag, searchPosts, incrementViewCount, getTopPosts };